...
''''
	Python3 PyPI pips:
		...
		include LICENSE with pip:
			...
			pip-licenses --with-license-file --format=json > /Metro/vehicles/Octave/Rules/Laboratory/PyPI_tenets_full.json
			pip-licenses > /Metro/vehicles/Octave/Rules/Laboratory/PyPI_tenets_outline.txt
