...
#
#
from Octave.adventures.ventures import retrieve_ventures
#
#
#from ventures.clique import ventures_clique
#from Octave.mixes._clique import mixes_clique
#
#
...
from Octave._health import monitor_health


#mixes_clique = importlib.import_module ("Octave.mixes._clique").mixes_clique
...
def clique ():
	...
	def command__build ():	
		...
		essence_path = str (normpath (join (CWD, "Octave_essence.py")))
		build (essence_path);
	...
	#/
	#
	#	This raises an exception if the "Octave_essence.py" is not yet built.
	#
	#
	try:
		from ventures.clique import ventures_clique
		...
		from Octave.adventures.demux_hap._plays._clique import demux_hap_clique
